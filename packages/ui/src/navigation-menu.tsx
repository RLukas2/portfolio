...
function NavigationMenuList({ className, ...props }: Readonly<ComponentProps<typeof List>>) {
  return (
    <List
...
function NavigationMenuItem({ className, ...props }: Readonly<ComponentProps<typeof Item>>) {
...
function NavigationMenuTrigger({ className, children, ...props }: Readonly<ComponentProps<typeof Trigger>>) {
  return (
    <Trigger
...
function NavigationMenuContent({ className, ...props }: Readonly<ComponentProps<typeof Content>>) {
  return (
    <Content
      className={cn(
...
function NavigationMenuViewport({ className, ...props }: Readonly<ComponentProps<typeof Viewport>>) {
  return (
...
function NavigationMenuLink({ className, ...props }: Readonly<ComponentProps<typeof Link>>) {
  return (
    <Link
      className={cn(
...
function NavigationMenuIndicator({ className, ...props }: Readonly<ComponentProps<typeof Indicator>>) {
  return (
    <Indicator
      className={cn(
