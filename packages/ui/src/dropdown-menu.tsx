...
function DropdownMenuPortal({ ...props }: Readonly<ComponentProps<typeof Portal>>) {
  return <Portal data-slot="dropdown-menu-portal" {...props} />;
}

function DropdownMenuTrigger({ ...props }: Readonly<ComponentProps<typeof Trigger>>) {
  return <Trigger data-slot="dropdown-menu-trigger" {...props} />;
}

function DropdownMenuContent({ className, sideOffset = 4, ...props }: Readonly<ComponentProps<typeof Content>>) {
  return (
    <Portal>
      <Content
        className={cn(
