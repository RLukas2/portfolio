...
function TabsList({ className, ...props }: Readonly<ComponentProps<typeof List>>) {
  return (
    <List
      className={cn(
...
function TabsTrigger({ className, ...props }: Readonly<ComponentProps<typeof Trigger>>) {
  return (
    <Trigger
      className={cn(
...
function TabsContent({ className, ...props }: Readonly<ComponentProps<typeof Content>>) {
